          ...
          body: TabBarView(
            children: [
              ...
              Center(
                ...
                width: 1000,
                child: Text(
                    'The app features 3 boxes or bars with different colors each with their own sliders. The sliders adjust the bar height, extending or shortening the bars.'),
              ))
            ],
          )),
    );
